...
SeatDepth=.4681; % in, below waterline
...
for i=1:numel(L)  
    [TotalWeight(i),StructureWeight(i),CGH(i),CGLShift(i),MCH(i),GunwaleHeight(i),WaterLineHeight(i),FloorWidth(i),LegMargin(i),FA(i),WA(i),SeatHeight(i)]=CalcCBParams(L(i),G(i),CabinWidth,GunwaleMargin,PersonWeight,SeatDepth,Nbay,PersonScale);
end
